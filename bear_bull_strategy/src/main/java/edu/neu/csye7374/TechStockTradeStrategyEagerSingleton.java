...
public class TechStockTradeStrategyEagerSingleton implements TradeStrategy {

    private String name;
    private MarketStrategyAlgorithm marketAlgorithm;
    public static final double K_FACTOR = 0.02;
    public static TechStockTradeStrategyEagerSingleton instance = new TechStockTradeStrategyEagerSingleton();

    public TechStockTradeStrategyEagerSingleton() {
